...
other_methods = pd.read_csv('/Users/sophia/Documents/REVEAL_SAM/examples/results_other_methods.csv')
LRP_REVEAL_methods = pd.read_csv('/Users/sophia/Documents/REVEAL_SAM/examples/results.csv')
...
# --------------------------------------------------------------------------------------------------
data_to_plot_1 = Same_other_methods[['input_t_gradient__blur_euclidean', 'integrated_gradients__blur_euclidean']]
...
# --------------------------------------------------------------------------------------------------
data_to_plot_1 = Same_other_methods[['input_t_gradient__gausian_small_euclidean', 'integrated_gradients__gausian_small_euclidean']]
...
# Renaming columns for the plot
result = result.rename(columns={'REVEAL__gausian_small_euclidean': 'CTC values', 'LRP__gausian_small_euclidean': 'LRP', 'input_t_gradient__gausian_small_euclidean': 'Input x Gradient', 'integrated_gradients__gausian_small_euclidean': 'Integrated Gradients'})

# # Plotting
sns.boxplot(data=result)
# plt.ylim(0, 2)
plt.title('Impact of Minor Gaussian Noise on Method Explanation Variability')
plt.ylabel('Distance Score')
plt.show()
