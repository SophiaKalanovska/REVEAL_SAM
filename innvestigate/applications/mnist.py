...
#from backend.utils import get_file
...
def _load_pretrained_net(modelname, new_input_shape):
    ...
    model_path = os.path.expanduser('~') + "/.backend/models/" + filename
    ...
    #NOTE: perform forward pass to fix a backend 2.2.0 related issue with improper weight initialization
